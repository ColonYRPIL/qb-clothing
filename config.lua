...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(461.03, -997.37, 31.13), width = 2, length = 2, cameraLocation = vector4(454.42, -990.52, 30.69, 358.48)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(306.04, -597.31, 43.28), width = 2, length = 2, cameraLocation = vector4(305.29, -599.86, 43.28, 339.49)}, -- Right double door in Hospital Map that is on QBCore GitHub
